...
test('domainService query and helpers use apiFetch', { concurrency: false }, async () => {
  const symbols: SymbolDef[] = [
    { id: '1', name: 'Test', triad: 'T', role: 'r', symbol_domain: 'demo', symbol_tag: 'tag', facets: {} as any, failure_mode: '', linked_patterns: [], macro: '', kind: 'pattern' },
    { id: '2', name: 'Other', triad: 'T', role: 'r', symbol_domain: 'demo', symbol_tag: 'tag', facets: {} as any, failure_mode: '', linked_patterns: [], macro: '', kind: 'pattern' }
  ];
  let called = '';
